...
def sendmail(c5):
    ...
    server.starttls()
    server.login('rjrahul5777@gmail.com','********')
    msg="SUCCESSFULL TRANSACTION FROM YOUR ACCOUNT"
    server.sendmail('rjrahul5777@gmail.com',c5,msg)
    server.quit()
...
def fun():
    ...
    list=["India","China","America","Japan","England"];
    dropList=OptionMenu(frame,country,*list)
    dropList.config(width=20)
    country.set('Select your State')
                                            ...
                                            def passbook():
                                                ...
                                                if(len(daf)<10):
                                                    for i in range(0,len(daf)):
                                                        Label(to1,text=('Amount left : {} = {}'.format(b,daf[i][1])),bd=1,font="italic").place(x=300,y=(0+y1))
                                                ...
                                                def fr3():
                                                    ...
                                                    if(dah1<0):
                                                        ...
                                                        def passbook1():
                                                            ...
                                                            Label(to12).place(x=100,y=0)
                                                            if(len(daf)<10):
                                                                for i in range(0,len(daf)):
                                                                    Label(to12,text=('Amount left : {} = {}'.format(b,daf[i][1])),bd=2,font="italic").place(x=300,y=(0+y1))
